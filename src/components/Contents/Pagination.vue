...
export default {
  ...
  mounted() {
    ...
    $(".paginationnav").append(
      "<li class='page-item' id='next-page'><a class='page-link' href='javascript:void(0)' aria-label='Next'><span aria-hidden='true'>&raquo;</span></a></li>"
    );
    ...
    $("#next-page").on("click", function() {
      ...
      if (currentPage === totalPages) {
        ...
        $(
          ".paginationnav li.current-page:eq(" + (currentPage - 1) + ")"
        ).addClass("active");
      }
    });
